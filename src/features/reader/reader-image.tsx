...
export function ReaderImageWindow({
  ...
  return (
    <div className="pointer-events-none relative h-[100dvh] w-[100dvw] overflow-hidden">
      {pages.map(page => {
        const offset =
        ...
        return (
          <div
            key={page.index}
            className={cn(
              'absolute inset-0 flex h-[100dvh] w-[100dvw] items-center justify-center transition-transform duration-200 ease-out will-change-transform',
              isCurrent ? 'z-10' : 'z-0'
            )}
          ...
          >
            <img
              src={page.src}
              alt=""
              className="h-[100dvh] w-[100dvw] select-none object-contain"
              draggable={false}
              loading="eager"
...
function ReaderDoublePageWindow({
  ...
  return (
    <div className="pointer-events-none flex h-[100dvh] w-[100dvw] items-center justify-center overflow-hidden px-3 py-3 sm:px-6 sm:py-6">
      <div
        className={cn(
